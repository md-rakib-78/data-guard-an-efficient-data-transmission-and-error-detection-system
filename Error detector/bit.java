...
public class bit extends Menu {
    ...
    bit() {
        ...
        super();
        JLabel p1 = new JLabel("Bit Stuffing & Destuffing");
        ...
        String str[] = { "Bit Stuffing", "Bit Destuffing" };
        ...
        // Input 1
        JLabel p3 = new JLabel("Input Bit: ");
        ...
        // Input 3
        JLabel p5 = new JLabel("Consecutive Number: ");
        p5.setFont(new Font("Arial", Font.BOLD, 17));
        p5.setForeground(Color.DARK_GRAY);
        p5.setBounds(570, 230, 190, 30);
        cp.add(p5);

        in2 = new JTextField();
        in2.setBounds(760, 230, 250, 40);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            File file = new File("TextFile/Bit.txt");
        ...
        if (e.getSource() == pb2) {
            ...
            if (selected.equals("Bit Stuffing")) {
                ...
                if ((!input.isEmpty()&&!input3.isEmpty()
                    ...
                    try {
                        FileWriter writer = new FileWriter("TextFile/Bit.txt");
                    ...
                    ll1 = new JLabel(
                            "<html><b>Selected Option: </b><i>" + selected + "</i><br><br><b>Original Data: </b><i>"
                                    + input
                                    + "</i><br><br><b>Flag: </b><i>" + input1 + "</i><br><br><b>Stuffed Data: </b><i>"
            ...
            } else if (selected.equals("Bit Destuffing")) {
                ...
                if (!input.isEmpty() && !result.equals("Invalid Input Field 1!")
                        && !result.equals("Invalid Input Field 2!")) {
                    String framedData = frameData(input1, result);
                    if (input1.isEmpty()) {
                        framedData = null;
                        input1 = null;
                    ...
                    ll1 = new JLabel(
                            "<html><b>Selected Option: </b><i>" + selected
                                    ...
                                    + "</i><br><br><b>Flag: </b><i>" + input1 + "</i><br><br><b>Destuffed Data: </b><i>"
                                    + result + "</i><br><br><b>Framed Data: </b><i>" + framedData + "</i></html>");
                    ll1.setFont(new Font("Arial", Font.PLAIN, 18));
                    ll1.setForeground(Color.BLACK);
                    ll1.setBounds(20, 10, screenW - 415, screenH / 3);
    ...
    public String checkout(String type, String input, String input1, String input2) {
        ...
        switch (type) {
            ...
            case "Bit Stuffing":
                ...
                if (input.isEmpty()) {
                    return "Please enter the input bit before proceeding!";
                }

                if (input2.isEmpty()) {
                    return "Please enter the input consecutive number before proceeding!";
                }

                int cn = Integer.parseInt(input2);

                if (cn < 1) {
                    return "Please enter the input consecutive number more than 0 before proceeding!";
                }
                ...
                String stuffedData = bitStuff(input, cn);
                Error = stuffedData;
            ...
            case "Bit Destuffing":
                ...
                int cn1 = Integer.parseInt(input2);
                ...
                String destuffedData = destuffBits(input, cn1);
                Error = destuffedData;
                break;
    ...
    public static String bitStuff(String data, int cn) {
    ...
    // Method for destuffing the bit-stuffed data
    public static String destuffBits(String stuffedData, int cn1) {
    ...
    // Method to add flag at start and end
    public static String frameData(String flag, String stuffedData) {
